...
/**
This class represents a Grid function for NURBS/hierarchical NURBS/T-Splines in parametric coordinates.
A Grid function is a function defined on the grid and interpolate the control values on its support domain.
 */
